...
cmake ../../../../libmedia-hub2-plugins -DCMAKE_BUILD_TYPE=Debug -DCMAKE_INSTALL_PREFIX=/usr -DPLUGIN_STORAGE=True -DPLUGIN_IDEV=True -DPLUGIN_CARPLAY=True -DB511=True 
make install DESTDIR=$SDKTARGETSYSROOT
make install DESTDIR=../../package
cd ..
...
cd ../..
#tar -xzf ../mDNSResponder-567.tar.gz
