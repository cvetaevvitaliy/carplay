...
#mkdir Support
#cd Support
#cmake ../../../../../../libmedia-hub2-plugins/carplay/sdk/Support -DCMAKE_BUILD_TYPE=Debug -DCMAKE_INSTALL_PREFIX=/usr 
#make install DESTDIR=$SDKTARGETSYSROOT
#make install DESTDIR=../../../../package 
#cd ..
...
cmake ../../../../libmedia-hub2-plugins -DCMAKE_BUILD_TYPE=Debug -DCMAKE_INSTALL_PREFIX=/usr -DPLUGIN_STORAGE=True -DPLUGIN_IDEV=True -DPLUGIN_CARLIFE=True
make install DESTDIR=$SDKTARGETSYSROOT
make install DESTDIR=../../package
cd ..
...
rm `ls | grep -v mh_api.h |grep -v mh_carlife.h` -rf
cd ../..
