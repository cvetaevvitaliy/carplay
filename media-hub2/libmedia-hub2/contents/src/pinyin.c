  unsigned char ps[MAX_GB_NUM][7] = { "a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", 
					 ...
					 "de", "deng", "di", "dian", "diao", "die", "ding", "diu", "dong", "dou",
					 "du", "duan", "dui", "dun", "duo", "e", "en", "er", "fa", "fan", 
					 ...
					 "nv","nuan", "nue", "nuo", "o", "ou", "pa", "pai", "pan", "pang",
