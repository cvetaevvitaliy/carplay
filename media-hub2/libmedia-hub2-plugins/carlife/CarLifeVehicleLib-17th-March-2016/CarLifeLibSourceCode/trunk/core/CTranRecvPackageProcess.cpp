...
void CTranRecvPackageProcess::packageHeadAnalysis(){
	...
	switch (type) {
		...
		case MSG_CMD_MIC_RECORD_WAKEUP_START:
			cout<<endl<<"*************************************MSG_CMD_MIC_RECORD_WAKEUP_START"<<endl;	
...
cout<<"cnt"<<cnt<<endl;	
				for(int i=0;i<cnt;i++){
					...
					cout<<"["<<i<<"]"<<" moduleID="<<pModuleStatus->moduleID<<endl;
					cout<<"statusID="<<pModuleStatus->statusID<<endl;
		...
		case MSG_VIDEO_DATA:
			//invoke registered callback function
//			cout<<"video_data--->timeStamp:"<<analyzedHead.packageDataTimeStamp<<"   size:"<<analyzedHead.packageDataSize<<endl;
		...
		case MSG_MEDIA_DATA:
			//invoke registered callback function
//			cout<<"media_data--->timeStamp:"<<analyzedHead.packageDataTimeStamp<<"   size:"<<analyzedHead.packageDataSize<<endl;
